...
const DEFAULT_STATE = { xp: 0, gems: 0, streak: 0, lastActive: null, lessons: {}, history: [], sound: true, profile: null, topicStats: {}, cloud: null, account: null, reminders: { enabled: false, morning: 480, evening: 1290 }, trips: {}, active: null, saved: [], goalsDone: {}, sessions: [], scoresCache: null };
const DEST_FIELDS = ["profile", "lessons", "topicStats", "xp", "sessions"];
let state = load();

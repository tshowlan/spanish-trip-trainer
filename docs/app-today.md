# THE APP TODAY (living page, maintained per ship · v281 · 2026-09-20)
...
- NUMBERS (numbers-1, v281): one session, met as a set and practised by ear: the set card (ten chips + the bills), the keypad (hear it and tap the number, say it on word keys, tap the bill), the numeral-to-word board, six how-many rungs, runs of three as the lap. Sound off: runs flash in one spot.

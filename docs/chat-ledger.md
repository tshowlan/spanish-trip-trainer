...
- **The Start pill** (v323, staged): the Home action tile carries a white pill with the verb (START / PRACTICE / DRILL / GO), the title drops "Start:", the sub reads topic · count. Wants the home-action-stack artifact updated.
...
- **The Start pill** (v323, staged "hero-start"): the Home action tile carries a white pill with the verb (START / PRACTICE / DRILL / GO); the title drops "Start:"; the sub reads topic · count. Option A of four mocked. Wants the home-action-stack artifact updated.

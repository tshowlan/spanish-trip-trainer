...
- **The bloom** (v306, staged): entering a session from the Home tile, a Practice option or a Learn row, the tapped thing lights up and a gold light grows to fill the screen while the next screen paints under it (380ms out, 260ms clear). Wants a motion ruling and the light's color against the design system.

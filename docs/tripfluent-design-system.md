...
- **Interstitial / ceremony grounds** (decisions 2026-07-17): interstitial and ceremony surfaces (score reveal, pattern moments, future Landed-Tripfluent, session summaries) use the **single top-center warm tint in both themes**; **home** uses photo + ground glow. One tint definition, theme-appropriate ground.

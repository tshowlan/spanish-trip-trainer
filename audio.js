...
try {
  ...
  // Correct: the ORIGINAL two-note chime, untouched - no added partials (Tom, 8/19: "I
  // liked the original sound I just wanted it to be louder") - normalized to 0.95 true
  // peak. Same waveform as day one, scaled to the loudest clean level.
  _renderClip([[659.25, 0, 0.12], [987.77, 0.09, 0.16]], 0.4, 0.95).then(el => _clips.correct = el);   // E5 + B5

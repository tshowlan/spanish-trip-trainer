...
const DEFAULT_STATE = { xp: 0, gems: 0, streak: 0, lastActive: null, lessons: {}, history: [], sound: true, profile: null, topicStats: {}, cloud: null };
let state = load();
...
async function doRestore(codeStr) {
  ...
  try {
    ...
    state.cloud = Object.assign({}, state.cloud, { playerId: id, secret, name: r.name, group: r.group_code, optedIn: true });
